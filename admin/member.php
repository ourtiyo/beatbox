        ...
        <div id="sideNav" href=""><i class="fa fa-caret-right"></i></div>
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="member.php"><i class="fa fa-users"></i> Data Member</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
              <div class="header"> 
                <h1 class="page-header">
                    Halaman Utama <small>Data Member</small>
                </h1>
                <ol class="breadcrumb">
                  <li><a href="#">Home</a></li>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $sql=mysql_query("select * from tb_member ORDER BY status ASC") or die(mysql_error());
                                                    
                                                    $no=0;
                                                    while ($row= mysql_fetch_array($sql)) 
                                                    {
                                                        $no++;
                                                        if(isset($_POST['konfirmasi'.$row['id']])) 
                                                        {
                                                            $status = $_POST['status'];
                                                            $tanggal = $_POST['tanggal'];
                                                            mysql_query("UPDATE tb_member SET status = '$status',
                                                                                              tgl_daftar ='$tanggal'
                                                                        where id='".$row['id']."'") 
                                                            or die(mysql_error());
                                                            ...
                                                            //sms gateway
                                                             ...
                                                             //input ke outbox
                                                            $no_hp = $row['telp'];
                                                            $pesan = "Selamat Datang ".$row['nama'].", di Samarinda Beatbox \nAkun anda telah aktif\nUsername : ".$row['nama']."\nPassword : ".$row['password'];
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                        <label></label>
                                                                        <span class="label label-success"><i class="fa fa-check"></i> Terkonfirmasi</span>
                                                                <?php
                                                                    }
                                                                    else{
                                                                ?>      
                                                                    <form method="post">
                                                                        ...
                                                                        <button class="btn btn-warning" type="submit" name="konfirmasi<?php echo $row['id']; ?>"><i class="fa fa-spinner fa-spin fa-fw"></i>Menunggu Konfirmasi</button>
                                                                    </form>
                                                            ...
                                                            <td><a href="hapus_member.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Yakin Ingin Menghapus?')"><i class="fa fa-trash-o fa-2x fa-fw"></i></a></td>
                                                        </tr>
                                                <?php
                                                    }
                                                ?>
