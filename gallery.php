		        ...
		        <div class="row">	        		
		            ...
		            <div class="collapse navbar-collapse">
		                <ul class="nav navbar-nav navbar-right">                 
		                    ...
		                    <li class="active"><a href="gallery.php">Galeri</a></li>                     
		                    ...
		                    <li class="dropdown">
							    ...
							    <ul class="dropdown-menu" style="background:#d9534f">
							      	<li style="border-bottom: 2px solid #fff;"><a class="ku" href="profile">Profile</a></li>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h2>Gallery</h2>
						<?php
							$sql_gallery = mysql_query("select * from tb_gallery ORDER BY id DESC") or die(mysql_error());
							while ($row_gallery = mysql_fetch_array($sql_gallery)) 
							{
						?>
							<div class="col-md-3 thumb">
								<a class="fancybox thumbnail" href='images/gallery/<?php echo $row_gallery['gambar'];?>' data-fancybox-group="gallery" > <img class="img-polaroid ku" src='images/gallery/<?php echo $row_gallery['gambar'];?>' alt="" /></a>
							</div>
						<?php
							}
						?>	
